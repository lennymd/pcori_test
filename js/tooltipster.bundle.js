    ...
    __geometry: function () {
      ...
      geo.available.window = {
        ...
        right: {
          height: geo.window.size.height,
          width: Math.max(
            geo.window.size.width - Math.max(geo.origin.windowOffset.right, 0),
            0
          ),
        },
        top: {
          ...
          // hides its overflow, we'll just hide (not close) the tooltip.
              ...
              self.__$originParents.each(function (i, el) {
                ...
                if (overflowX != 'visible' || overflowY != 'visible') {
                  ...
                  if (overflowX != 'visible') {
                    if (
                      geo.origin.windowOffset.left < bcr.left ||
                  ...
                  if (overflowY != 'visible') {
                    if (
                      geo.origin.windowOffset.top < bcr.top ||
            ...
            if (overflows) {
              ...
              // or just adjust offset
                ...
                var offsetLeft =
                    geo.origin.offset.left - self.__Geometry.origin.offset.left,
                  offsetTop =
                    geo.origin.offset.top - self.__Geometry.origin.offset.top;
              ...
              // if the tooltip isn't already open, open it
                ...
                if (env.hasTransitions) {
                  ...
                  self._$tooltip
                    ...
                    .css({
                      '-moz-animation-duration':
                        self.__options.animationDuration[0] + 'ms',
                      '-ms-animation-duration':
                        self.__options.animationDuration[0] + 'ms',
                      '-o-animation-duration':
                        self.__options.animationDuration[0] + 'ms',
                ...
                $(env.window)
                  ...
                  .on(
                    'resize.' + self.__namespace + '-triggerClose',
                    function (e) {
                  ...
                  .on(
                    'scroll.' + self.__namespace + '-triggerClose',
                    function (e) {
                ...
                if (
                  ...
                  if (self.__options.triggerClose.mouseleave) {
                    eventNamesIn +=
                      'mouseenter.' + self.__namespace + '-triggerClose ';
                    eventNamesOut +=
                      'mouseleave.' + self.__namespace + '-triggerClose ';
                  }
                  if (
                    self.__options.triggerClose.touchleave &&
                    env.hasTouchCapability
                    ...
                    eventNamesIn +=
                      'touchstart.' + self.__namespace + '-triggerClose';
                    eventNamesOut +=
                      'touchend.' +
                      self.__namespace +
                ...
                if (self.__options.triggerClose.originClick) {
                  self._$origin.on(
                    'click.' + self.__namespace + '-triggerClose',
                    function (event) {
                  ...
                  setTimeout(function () {
                    if (self.__state != 'closed') {
                      ...
                      if (
                        ...
                        eventNames +=
                          'touchend.' + self.__namespace + '-triggerClose';
                      }
                      ...
                      $body.on(eventNames, function (event) {
                        if (self._touchIsMeaningfulEvent(event)) {
                          ...
                          if (
                            ...
                            !$.contains(self._$tooltip[0], event.target)
                          ) {
                            self._close(event);
                          }
                        }
  ...
  $.tooltipster._plugin({
    ...
    instance: {
      ...
      __init: function (instance) {
        ...
        self.__namespace =
          'tooltipster-sideTip-' + Math.round(Math.random() * 1000000);
      ...
      __reposition: function (event, helper) {
          ...
          if (
            ...
            for (var i = 0; i < self.__options.side.length; i++) {
              ...
              $.each(['natural', 'constrained'], function (i, mode) {
                ...
                if (
                  takeTest == true ||
                  (takeTest != false && satisfied == false)
                ) {
                  var testResult = {
                    container: container,
                  ...
                  var rulerConfigured =
                      mode == 'natural'
                        ? ruler.free()
                        : ruler.constrain(
                            helper.geo.available[container][side].width -
                              distance.horizontal,
                            helper.geo.available[container][side].height -
                              distance.vertical
                          ),
                      ...
                      if (side == 'top' || side == 'bottom') {
                        testResult.whole =
                          helper.geo.origin.windowOffset.right >=
                            self.__options.minIntersection &&
        ...
        switch (finalResult.side) {
          case 'left':
            finalResult.coord.left =
              helper.geo.origin.windowOffset.left - finalResult.outerSize.width;
            break;
          ...
          case 'top':
            finalResult.coord.top =
              helper.geo.origin.windowOffset.top - finalResult.outerSize.height;
            break;
        ...
        if (finalResult.container == 'window') {
          ...
          if (finalResult.side == 'top' || finalResult.side == 'bottom') {
            ...
            // or at the bottom
              ...
              finalResult.coord.top >
              helper.geo.window.size.height - finalResult.size.height
            ) {
              if (
                helper.geo.origin.windowOffset.top +
                  this.__options.minIntersection <=
        ...
        finalResult.distance =
          finalResult.distance.horizontal || finalResult.distance.vertical;
        ...
        if (helper.geo.origin.fixedLineage) {
          ...
          originParentOffset = {
            ...
            top:
              helper.geo.origin.windowOffset.top + helper.geo.window.scroll.top,
          };
        }
        ...
        finalResult.coord = {
          left:
            ...
            (finalResult.coord.left - helper.geo.origin.windowOffset.left),
          top:
            originParentOffset.top +
            (finalResult.coord.top - helper.geo.origin.windowOffset.top),
        };
